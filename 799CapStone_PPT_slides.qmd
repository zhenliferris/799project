...
format: 
  revealjs:
    footer: "DSAN CapStone Project"
    theme: dark
    footnotes-hover: true
    transition: slide
    title-slide-attributes: 
      data-background-image: background.jpg!d
editor: visual
...
-   Fever is typically a very common symptom of diseases that can severely threaten public health, such as the recently experienced global outbreak of the COVID19.
...
-   The goal of this project is to attempt to establish a good model that accurately predicts the oral temperature of individuals using quickly obtained facial temperature from certain areas and other easily measurable parameters.
...
## components contribution continued
...
#| message: false
#| fig-align: center
#| code-line-numbers: "|1-16|20,21,23"
# Prepare the data
